    ...
    def new_deformation(self, device):
        ...
        if self.fixed_img_DF:
            ...
            for i in range(shape[-4]):
                noise_3d_i = rand_perlin_3d(s, (4, 4, 4)) * 0.05 * random_scale
                noise_3d_i += rand_perlin_3d(s, (8, 8, 8)) * 0.03 * random_scale
                noise_3d_i += rand_perlin_3d(s, (2, 2, 2)) * 0.2 * random_scale
                noise_3d_i = noise_3d_i[: shape[-3], : shape[-2], : shape[-1]]
                noise_3d.append(noise_3d_i)
        else:
            for i in range(shape[-4]):
                noise_3d_i = rand_perlin_3d(s, (4, 4, 4)) * 0.05 * random_scale_01
                noise_3d_i += rand_perlin_3d(s, (8, 8, 8)) * 0.03 * random_scale_02
                noise_3d_i += rand_perlin_3d(s, (2, 2, 2)) * 0.2 * random_scale_03
                noise_3d_i = noise_3d_i[: shape[-3], : shape[-2], : shape[-1]]
                noise_3d.append(noise_3d_i)
